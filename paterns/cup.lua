...
-- made with <3 by Souka, based on Kettle by Dully
-- my first attempt at a more advanced pattern, think it turned out great! :>
...
l = 6.25 * 4 -- long walk
s = l / 4 -- short walk
h = l / 2 -- half long walk

digiStops = false -- true/false

local function ds(ms)
    if digiStops == true then
        Sleep(ms)
    end
end
